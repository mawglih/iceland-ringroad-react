        ...
        <div className="col-1-of-4 u-margin-bottom-small">
            <div className="card">
                <div className="card__side card__side--front">
                    <div className={`card__picture card__picture-index-${this.props.class1}`}>
                    
                    </div>
                    <h4 className="card__heading">
                        <span className={`card__heading-span card__heading-span-index-${this.props.clas1s}`}>{this.props.title}</span>
                    </h4>
                    <div className="card__detail">
                        <p>{this.props.text}</p>
                    </div>
                </div>
                <div className={`card__side card__side--back card__side--back-index-${this.props.class1}`}>
